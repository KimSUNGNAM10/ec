...
public class PlayerVO {
	...
	public PlayerVO(int rank, String player, String team, int goal, int assist, int offense_point, int shooting,
	...
	public String toString() {
		return "playerVO [rank=" + rank + ", player=" + player + ", team=" + team + ", goal=" + goal + ", assist="
